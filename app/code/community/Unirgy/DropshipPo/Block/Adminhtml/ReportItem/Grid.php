...
class Unirgy_DropshipPo_Block_Adminhtml_ReportItem_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()
            ...
            ->join(array('t'=>$res->getTableName('udpo/po')), 't.entity_id=main_table.parent_id', array('udropship_vendor', 'udropship_available_at', 'udropship_method', 'udropship_method_description', 'udropship_status', 'base_shipping_amount', 'po_increment_id'=>'increment_id', 'created_at'))
