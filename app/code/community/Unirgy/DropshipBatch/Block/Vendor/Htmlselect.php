...
class Unirgy_DropshipBatch_Block_Vendor_Htmlselect extends Varien_Data_Form_Element_Select
{
    public function getValues()
    {
        $values = $this->getData('values');
        return empty($values) ? Mage::getSingleton('udbatch/source')->setPath('vendors_import_orders')->toOptionArray() : $values;
    }
    protected function _getValues()
    {
        return Mage::getSingleton('udbatch/source')->setPath('vendors_import_orders')->toOptionHash();
    }
            ...
            <script type="text/javascript">
            	(function () {
                	...
                	new Ajax.Autocompleter(
                        ...
                        "'.Mage::getModel('core/url')->getUrl('udbatch/index/vendorAutocomplete').'",
                        {
