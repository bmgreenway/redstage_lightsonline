...
class Unirgy_DropshipBatch_Block_Adminhtml_SystemConfigFormField_ExportTemplates extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    public function __construct()
    {
        parent::__construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('udbatch/system/form_field/export_templates.phtml');
        }
    }
