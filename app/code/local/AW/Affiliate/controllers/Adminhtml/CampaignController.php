...
class AW_Affiliate_Adminhtml_CampaignController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function saveAction()
    {
        ...
        if ($data) {
            ...
            if (isset($data['active_from']) && $data['active_from'] && ($_activeFrom = Mage::helper('awaffiliate')->strToTime($data['active_from']))) {
                $data['active_from'] = date(AW_Affiliate_Model_Resource_Campaign::MYSQL_DATE_FORMAT, $_activeFrom);
            } else {
                $data['active_from'] = null;
            }
            if (isset($data['active_to']) && $data['active_to'] && ($_activeTo = Mage::helper('awaffiliate')->strToTime($data['active_to']))) {
            ...
            if (isset($data['rule']['conditions'])) {
                $rule['conditions'] = $data['rule']['conditions'];
            }
            unset($data['rule']);
            $campaign->setProductSelectionRule($rule);
