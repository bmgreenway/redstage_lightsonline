...
class AW_Affiliate_Block_Adminhtml_Campaign_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('status', array(
            ...
            'index' => 'status',
            'type' => 'options',
            'options' => Mage::getModel('awaffiliate/source_campaign_status_expanded')->toShortOptionArray(),
            'width' => '100px',
            'renderer' => 'AW_Affiliate_Block_Adminhtml_Campaign_Grid_Column_Renderer_Status',
            'filter_condition_callback' => array($this, 'statusExpandedFilterCallback')
        ));
    ...
    public function statusExpandedFilterCallback($collection, $column)
    {
        $collection->addStatusExpandedFilter($column->getFilter()->getValue());
        return $this;
    }
