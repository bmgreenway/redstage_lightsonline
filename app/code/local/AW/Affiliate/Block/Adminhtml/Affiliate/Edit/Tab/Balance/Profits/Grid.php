...
class AW_Affiliate_Block_Adminhtml_Affiliate_Edit_Tab_Balance_Profits_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('order_id', array(
            ...
            'type' => 'number',
            'renderer' => 'awaffiliate/adminhtml_widget_grid_column_renderer_order',
            'width' => '50px',
        ));
        $this->addColumn('rate', array(
            ...
            'type' => 'number',
            'width' => '25px',
            'renderer' => 'awaffiliate/adminhtml_widget_grid_column_renderer_rate',
        ));
        $this->addColumn('attracted_amount', array(
            'header' => $helper->__('Attracted amount'),
            'index' => 'attracted_amount',
            'type' => 'currency',
            'currency' => 'currency_code',
            'width' => '25px',
            'renderer' => 'awaffiliate/adminhtml_widget_grid_column_renderer_attracted',
            'default' => Mage::app()->getLocale()->currency($_currencyCode)->toCurrency(0.00),
        ));
