...
class AW_Google_Share_Helper_Data extends Mage_Core_Helper_Abstract
{
    const PARAM_HTML_TAG     = 'html_tag';
    const PARAM_HEIGHT       = 'height';
    const PARAM_ACTION       = 'action';
    const ACTION_SHARE       = 'share';
    const PARAM_WIDTH        = 'width';
    const PARAM_ANNOTATION   = 'annotation';
    ...
    {
        return Mage::getStoreConfig('googleshare/general/annotation', Mage::app()->getStore()->getId());
    }

    public function getHeight()
    {
        return Mage::getStoreConfig('googleshare/general/height', Mage::app()->getStore()->getId());
    }

    public function getWidth()
    {
        return Mage::getStoreConfig('googleshare/general/width', Mage::app()->getStore()->getId());
    }

    public function getButtonCode()
    {
        return Mage::getStoreConfig('googleshare/general/button_code', Mage::app()->getStore()->getId());
    }
    ...
    {
        return Mage::getStoreConfig('googleshare/content/show_in_cms', Mage::app()->getStore()->getId());
    }

    public function isShowInHome()
    {
        return Mage::getStoreConfig('googleshare/content/show_in_home', Mage::app()->getStore()->getId());
    }

    public function isShowOnProductPage()
    {
        return Mage::getStoreConfig('googleshare/content/show_in_product', Mage::app()->getStore()->getId());
    }

    public function isShowInCategoryPage()
    {
        return Mage::getStoreConfig('googleshare/content/show_in_category', Mage::app()->getStore()->getId());
    }

    public function isShowCustom()
    {
        return Mage::getStoreConfig('googleshare/content/show_custom', Mage::app()->getStore()->getId());
    }

    public function isShowWidget()
    {
        return Mage::getStoreConfig('googleshare/content/show_widget', Mage::app()->getStore()->getId());
    }
    ...
    public  function getGoogleJsHtml()
    {
        ...
        if (!Mage::registry('aw_google_html')) {
            $src = self::GOOGLE_APIS_JS_URL . AW_Google_Share_Block_Abstract::URL;
