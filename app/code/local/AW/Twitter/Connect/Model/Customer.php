...
class AW_Twitter_Connect_Model_Customer extends Mage_Customer_Model_Customer
{
	protected $_twitter;
	...
	public function loadByTwitterUserId($twitterCustomerId=null)
	{
		...
		if(!$customerId = $this->getConnection()->getCustomerId()) {
            ...
            if(!($synch instanceof AW_Twitter_Connect_Model_Synch) || (!$customerId = $synch->getCustomerId())) {
                return $this;
            }
		}
